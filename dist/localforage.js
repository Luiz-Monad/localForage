...
function _encodeBlob(blob) {
  return new Promise$1(function (resolve, reject) {
    ...
    reader.onloadend = function (e) {
      var _a;
      var base64 = btoa(((_a = e.target) === null || _a === void 0 ? void 0 : _a.result) || '');
      resolve({
      ...
      createTransaction(self._dbInfo, READ_WRITE, function (err, transaction) {
        ...
        try {
          ...
          transaction.onabort = transaction.onerror = function () {
            var _a;
            var err = req.error ? req.error : (_a = req.transaction) === null || _a === void 0 ? void 0 : _a.error;
            reject(err);
          };
        } catch (e) {
          reject(e);
...
function dropInstance(_options, callback) {
...
function serialize(value, callback) {
  ...
  if (value && (valueType === '[object ArrayBuffer]' || value.buffer && toString$1.call(value.buffer) === '[object ArrayBuffer]')) {
    ...
    fileReader.onload = function () {
      ...
      var str = BLOB_TYPE_PREFIX + blobValue.type + '~' + bufferToString(this.result);
    ...
    self.ready().then(function () {
      ...
      dbInfo.db.transaction(function (t) {
        tryExecuteSql(t, dbInfo, "SELECT * FROM ".concat(dbInfo.storeName, " WHERE key = ? LIMIT 1"), [key], function (t, results) {
          ...
          // unpack.
          if (sresult) {
            result = dbInfo.serializer.deserialize(sresult);
          }
          resolve(result);
        }, function (t, error) {
          reject(error);
      ...
      dbInfo.db.transaction(function (t) {
        tryExecuteSql(t, dbInfo, "SELECT * FROM ".concat(dbInfo.storeName), [], function (t, results) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            // we need to unpack.
            if (sresult) {
              oresult = dbInfo.serializer.deserialize(sresult);
            }
...
function dropInstance$1(_options, callback) {
  callback = getCallback.apply(this, arguments);
  var currentConfig = this.config();
  _options = typeof _options !== 'function' && _options || {};
  if (!_options.name) {
...
function dropInstance$2(_options, callback) {
  callback = getCallback.apply(this, arguments);
  _options = typeof _options !== 'function' && _options || {};
  if (!_options.name) {
    var currentConfig = this.config();
  ...
  _createClass(LocalForage, [{
    ...
    value: function config(options) {
      ...
      if (_typeof(options) === 'object') {
        ...
        for (var i in options) {
          if (i === 'storeName') {
            options[i] = (_a = options[i]) === null || _a === void 0 ? void 0 : _a.replace(/\W/g, '_');
          }
